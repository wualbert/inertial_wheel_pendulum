// ======================================================================
// IWP.v generated from TopDesign.cysch
// 05/15/2018 at 18:01
...
module ADC_SAR_v3_0_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("a0daeb2a-abb0-4303-9c0c-ce2bbe57d86d/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Cnt16, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_Shoulder:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=QuadDec_Shoulder_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=4, CounterSize=32, CounterSizeReplacementString=int32, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec_Shoulder, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_Shoulder, CY_INSTANCE_SHORT_NAME=QuadDec_Shoulder, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=QuadDec_Shoulder, )
...
module top ;
    ...
    QuadDec_v3_0_4 QuadDec_Motor (
        .quad_A(Net_444),
        .quad_B(Net_445),
        .index(1'b0),
        .clock(Net_447),
        .interrupt(Net_448));
    defparam QuadDec_Motor.CounterResolution = 4;
    defparam QuadDec_Motor.UsingGlitchFiltering = 0;
    defparam QuadDec_Motor.UsingIndexInput = 0;

    QuadDec_v3_0_6 QuadDec_Shoulder (
        .quad_A(Net_439),
        .quad_B(Net_440),
        .index(1'b0),
        .clock(Net_442),
        .interrupt(Net_443));
    defparam QuadDec_Shoulder.CounterResolution = 4;
    defparam QuadDec_Shoulder.UsingGlitchFiltering = 1;
    defparam QuadDec_Shoulder.UsingIndexInput = 0;
	...
	wire [0:0] tmpOE__ADC1_In_net;
	wire [0:0] tmpFB_0__ADC1_In_net;
	wire [0:0] tmpIO_0__ADC1_In_net;
	wire [0:0] tmpINTERRUPT_0__ADC1_In_net;
	...
	assign tmpOE__ADC1_In_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("144fb6cb-81cd-43c5-add5-a9866d5f7c3b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Shoulder_A_net;
	wire [0:0] tmpIO_0__Shoulder_A_net;
	wire [0:0] tmpINTERRUPT_0__Shoulder_A_net;
	electrical [0:0] tmpSIOVREF__Shoulder_A_net;

	cy_psoc3_pins_v1_10
		#(.id("5122fcb2-ec47-4b78-9456-72651b08579e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Shoulder_A
		 (.oe(tmpOE__Shoulder_A_net),
		  .y({1'b0}),
		  .fb({Net_439}),
		  .io({tmpIO_0__Shoulder_A_net[0:0]}),
		  .siovref(tmpSIOVREF__Shoulder_A_net),
		  .interrupt({tmpINTERRUPT_0__Shoulder_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Shoulder_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Shoulder_B_net;
	wire [0:0] tmpIO_0__Shoulder_B_net;
	wire [0:0] tmpINTERRUPT_0__Shoulder_B_net;
	electrical [0:0] tmpSIOVREF__Shoulder_B_net;

	cy_psoc3_pins_v1_10
		#(.id("ed350166-84b9-424d-a859-9b97a4d64202"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Shoulder_B
		 (.oe(tmpOE__Shoulder_B_net),
		  .y({1'b0}),
		  .fb({Net_440}),
		  .io({tmpIO_0__Shoulder_B_net[0:0]}),
		  .siovref(tmpSIOVREF__Shoulder_B_net),
		  .interrupt({tmpINTERRUPT_0__Shoulder_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Shoulder_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Shoulder_I_net;
	wire [0:0] tmpIO_0__Shoulder_I_net;
	wire [0:0] tmpINTERRUPT_0__Shoulder_I_net;
	electrical [0:0] tmpSIOVREF__Shoulder_I_net;

	cy_psoc3_pins_v1_10
		#(.id("1d17cbf1-c90c-477b-847d-658033616e1c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Shoulder_I
		 (.oe(tmpOE__Shoulder_I_net),
		  .y({1'b0}),
		  .fb({Net_584}),
		  .io({tmpIO_0__Shoulder_I_net[0:0]}),
		  .siovref(tmpSIOVREF__Shoulder_I_net),
		  .interrupt({tmpINTERRUPT_0__Shoulder_I_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Shoulder_I_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c27d7a8f-ca2a-4904-8e4d-f59ad60e5098"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam GlitchFilter_1.GlitchLength = 10;
